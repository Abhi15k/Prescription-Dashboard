        ...
        <Right>
          { user_type === "medical" ? 
            <>
              ...
              <MenuItem onClick={() => navigate('/MedicalPrescription')}>Prescription</MenuItem>
              <MenuItem onClick={() => navigate('/Setting')}>Settings</MenuItem>
              <MenuItem onClick={() => navigate('/About')}>About_uS</MenuItem>
              <MenuItem onClick={() => navigate('/Contact')}>Contact_Us</MenuItem>
            ...
            <>
              ...
              <MenuItem onClick={() => navigate('/UserPresc')}>View_Prescription</MenuItem>
              <MenuItem onClick={() => navigate('/Complaint')}>Complaint</MenuItem>
            ...
            <>
              ...
              <MenuItem onClick={() => navigate('/Patient')}>View_Patient</MenuItem>
              <MenuItem onClick={() => navigate('/Prescription')} >Prescription</MenuItem>
              <MenuItem onClick={() => navigate('/Setting')}>Setting</MenuItem>
              <MenuItem onClick={() => navigate('/About')}>About_Us</MenuItem>
              <MenuItem onClick={() => navigate('/Contact')}>Contact_Us</MenuItem>
