...
export const AuthContextProvider = ({children}) => {
    ...
    return  (
        <AuthContext.Provider value={{ user, Login, user_type, loggedIn, Logout,trackgeneration,trackNo,user_email,AddToCart,getCart,removeToCart,url,trackId }}>
            {children}
...
export function useAuthContext(){
    const {user, Login, user_type, loggedIn, Logout,trackgeneration,trackNo,user_email,cart,AddToCart,getCart,removeToCart,url,trackId} =  useContext(AuthContext);
    return {user, Login, user_type, loggedIn, Logout,trackgeneration,trackNo,user_email,cart,AddToCart,getCart,removeToCart,url,trackId};
}
